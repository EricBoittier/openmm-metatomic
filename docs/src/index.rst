...
The gallery includes **PET-MAD-XS** (`lab-cosmo/upet`_): the extra-small
v1.5.0 TorchScript export is vendored at ``models/pet-mad-xs-v1.5.0.pt``
(~20 MB) and run through OpenMM-ML as a pure-ML water molecule and as the
